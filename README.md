...
Welcome to EduNest! This is a simple, easy-to-use web application that helps you find homes and visually explore nearby schools on an interactive map in Jefferson County, Kentucky.
...
3. Just click "Next" through the standard installation steps. You do not need to change any default settings.
...
1. Tell the terminal to look inside the EduNest folder:
   ```bash
   cd path/to/EduNest
...
Filter Homes: Only want a 3-bedroom house under $300k? Use the sliders and dropdowns to filter the results.

Explore the Map: Click on the map markers to see the exact locations of properties and nearby educational facilities.
...
Problem: You see an error saying "npm is not recognized"
...
Problem: You double-clicked index.html and the screen is blank
...
Problem: No homes are showing up on the map
Fix: - You might have a typo in the school search box. Try typing a simpler part of the name.

Your filters might be too strict. Try changing the bedrooms and bathrooms back to "Any" and increasing the maximum price.
